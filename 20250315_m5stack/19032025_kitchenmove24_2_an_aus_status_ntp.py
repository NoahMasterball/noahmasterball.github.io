...
ALLOWED_GAP = 30              # 30 s zwischen Bewegungen => Sitzung reset
MAX_LED_TIME = 180
BLINK_INTERVAL = 0.5
...
# Wird gesetzt, wenn das Licht manuell ausgeschaltet wird.
# Während dieser 30 Minuten (1800 s) wird der PIR-Mechanismus ignoriert.
        ...
        if btnA_press_start is not None:
            ...
            if press_duration >= 1.5:
                ...
                if overhead_light_is_on():
                    ...
                    # Reset des Bewegungstimers, damit kein alter Timer später das Licht wieder einschaltet:
                    session_start = None
                    last_event_time = None
                    presence_active = False
                else:
