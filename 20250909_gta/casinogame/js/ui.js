        ...
        button.addEventListener('click', () => {
            ...
            switch(section) {
                ...
                case 'options':
                    ...
                    break;
                case 'leave':
                    if (typeof sharedCredits !== 'undefined' && sharedCredits && sharedCredits.getCredits) {
                        sharedCredits.setCredits(sharedCredits.getCredits());
                    }
                    window.location.href = '../overworld/index.html';
                    return;
            }
        });
    });
