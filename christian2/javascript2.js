...
function flowortypes() {
    ...
    style = "flow";
    pause = "nein";
    //TODO: du muss noch dass  lösend ass der bus immer wegfähr
    ...
    document.getElementById("word1").className = "word1unsichtbar text";
    document.getElementById("ebeneinput").className = "ebeneinput ebeneinputunsichtbar";
    document.getElementById("word1").innerHTML = word.german;
...
function addvisibility() {
    if (style == "flow") {
      if (zaehler % 2 == 0) {
        document.getElementById("word1").className ="word1sichtbar text";
        zaehler++;
      } else {
        document.getElementById("word1").className ="word1sichtbar word1unsichtbar text";
        zaehler++;
      }
    }
  }
...
function showWordsssss() {
    ...
    if (pause == "ja") {
      ...
      if (currentWord >= vocabularyarray.length) {
        ...
        document.getElementById("word2").innerHTML = "Alles Fertig!";
        document.getElementById("word1").innerHTML = "All done - finished";
      ...
      if (style == "flow") {
        ...
        if (myLanguage == "deutsch") {
          document.getElementById("word2").innerHTML = word.german;
          document.getElementById("word1").innerHTML = word.english;
          //console.log("nach wortausgabe lang = deutsch");
          //console.log(word.german);
          //console.log(word.english);
          currentWord++;
        } else {
          document.getElementById("word2").innerHTML = word.english;
          document.getElementById("word1").innerHTML = word.german;
...
function comparewortdeutschdd () {
    ...
    if (currentWord >= vocabularyarray.length-(1)) {
      ...
      document.getElementById("word1").innerHTML = "Great Job, All done!";
      document.getElementById("ebenebus").className = "ebenebus animationmiddle pause";
...
// prettier-ignore
function comparewortenglishddd() {
    ...
    if (currentWord >= vocabularyarray.length - 1) {
      ...
      document.getElementById("word1").innerHTML = "Gute Arbeit!";
      document.getElementById("ebenebus").className = "ebenebus animationmiddle pause";
      console.log("start function showWord - last word reached cleared intervall");
      clearInterval(interval);
      return;
