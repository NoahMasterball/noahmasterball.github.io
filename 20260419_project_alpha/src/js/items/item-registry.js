...
// Deltas aus constants.js). Waffen-onUse kommt in Batch 5.
...
define(ItemId.MELEE_BAT,      { type: ItemType.WEAPON_MELEE,  name: 'Baseballschläger', color: ITEMS.COLOR.WEAPON });
define(ItemId.PISTOL,         { type: ItemType.WEAPON_LIGHT,  name: 'Pistole',          color: ITEMS.COLOR.WEAPON });
define(ItemId.SHOTGUN,        { type: ItemType.WEAPON_LIGHT,  name: 'Schrotflinte',     color: ITEMS.COLOR.WEAPON });
define(ItemId.MACHINE_GUN,    { type: ItemType.WEAPON_HEAVY,  name: 'Maschinengewehr',  color: ITEMS.COLOR.WEAPON, heavy: true });
